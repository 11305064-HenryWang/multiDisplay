    ...
    protected override void Layout()
{
    ...
    foreach (var info in monitors) {
        ...
        // Calculate position directly relative to Vector3.zero as the circle's center
        var pos = radius * new Vector3(Mathf.Sin(angle), 0f, Mathf.Cos(angle));
        pos = offsetRot * pos; // Apply the offset rotation to the position
